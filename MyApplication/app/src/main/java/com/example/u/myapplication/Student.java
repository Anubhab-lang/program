...
public class Student implements Serializable{
    ...
    public Student(long id, String name, int age, String sex, String phoneNumber, String trainDate, String modifyDateTime) {
        super();
        this.id = id;
        this.name = name;
        this.age = age;
    ...
    public Student(String name, int age, String sex, String phoneNumber, String trainDate, String modifyDateTime) {
        super();
        this.name = name;
        this.age = age;
        this.sex = sex;
