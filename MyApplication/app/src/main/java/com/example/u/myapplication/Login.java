...
public class Login extends Activity {                 //登录界面活动
    ...
    private TextView ManagerLogin;               //管理员登陆
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ManagerLogin = (TextView) findViewById(R.id.login_text_manager);
        ...
        ManagerLogin.setOnClickListener(mListener);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.login_text_change_pwd:                             //登录界面的注销按钮
                    ...
                    finish();
                    break;
                case  R.id.login_text_manager:                      //管理员登陆界面
                    Intent intent_Login_to_ManagerLogin = new Intent(Login.this, com.example.u.myapplication.ManagerLogin.class);
                    startActivity(intent_Login_to_ManagerLogin);
                    finish();
                    break;
            }
        }
    ...
    public void login() {                                              //登录按钮监听事件
        if (isUserNameAndPwdValid()) {
            ...
            if(result==1){                                             //返回1说明用户名和密码均正确
                ...
                editor.commit();
                Intent intent = new Intent(Login.this,StudentListActivity.class) ;    //切换Login Activity至StudentListActivity Activity
